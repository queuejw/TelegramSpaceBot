...
BOT_USERNAME = "@qkosmos_bot"  # Юзернейм бота
DEVELOPER_USERNAME = "@pawxaff"  # Ты просто бездушное животное, если поменяешь мой юзернейм на свой. Прояви уважение, просто добавь себя рядом.
